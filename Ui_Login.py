...
class Ui_Dialog_login(object):
    def setupUi(self, Dialog_login):
        ...
        self.label.setGeometry(QtCore.QRect(36, 35, 71, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.label_2.setGeometry(QtCore.QRect(56, 92, 51, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        ...
        self.label_3.setGeometry(QtCore.QRect(55, 148, 51, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        ...
        self.lineEdit_user.setGeometry(QtCore.QRect(120, 35, 211, 31))
        font = QtGui.QFont()
        ...
        self.lineEdit_passwd.setGeometry(QtCore.QRect(120, 93, 211, 31))
        self.lineEdit_passwd.setObjectName("lineEdit_passwd")
        self.comboBox_gongdui = QtWidgets.QComboBox(Dialog_login)
        self.comboBox_gongdui.setGeometry(QtCore.QRect(120, 150, 211, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
